...
public:
    ...
    /*
     * Destructor for gamestate, deletes every Robot
     * pointer in vector Robots.
     */
    ~GameState();

    /*
     * Creates a copy of a GameState,
     * cloning the Robots from the chosen GameState.
     */
    GameState(const GameState& gameState);

    /*
     * Assignment Operator, clears current Robot vector
     * then creates a copy of the chosen GameStates Robots
     * by cloning them.
     */
